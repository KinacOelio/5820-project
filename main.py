...
#keywords are used to denote the begggining and and of a title and of a comment to help it generaete comments better.
...
for submission in reddit.subreddit("SubSimulatorGPT2").hot():
    ...
    for comment in top_level_comments:
        SubSimulatorGPT2_comments.write("[start] " + comment.body + " [end]\n")
